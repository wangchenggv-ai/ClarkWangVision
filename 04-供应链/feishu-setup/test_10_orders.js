...
async function main() {
  ...
  const orders = [
    ...
    { "订单编号": "SIM-001", "下单日期": now, "SKU": "Ultra -1.00",           "数量": 2 },
    { "订单编号": "SIM-002", "下单日期": now, "SKU": "Ultra双效 -1.50",       "数量": 3 },
    { "订单编号": "SIM-003", "下单日期": now, "SKU": "AB版 -1.25",            "数量": 2 },

    // 4-5: Large qty → likely exceeds stock → "定制5天"
    { "订单编号": "SIM-004", "下单日期": now, "SKU": "Ultra双效 -0.75/-0.50", "数量": 50 },
    { "订单编号": "SIM-005", "下单日期": now, "SKU": "A版 -1.00",             "数量": 30 },

    // 6: Abnormal qty > 100 → "待人工审核"
    { "订单编号": "SIM-006", "下单日期": now, "SKU": "Ultra -2.00",           "数量": 200 },

    // 7: Positive diopter → "待人工审核"
    { "订单编号": "SIM-007", "下单日期": now, "SKU": "Ultra +1.50",           "数量": 5 },

    // 8-9: A-class high-demand SKUs (push-stock strategy)
    { "订单编号": "SIM-008", "下单日期": now, "SKU": "Ultra双效 -2.25/-0.50", "数量": 4 },
    { "订单编号": "SIM-009", "下单日期": now, "SKU": "Ultra双效 -1.75/-0.50", "数量": 3 },

    // 10: Low-stock SKU (should go custom)
    { "订单编号": "SIM-010", "下单日期": now, "SKU": "D8",                    "数量": 5 },
  ];
