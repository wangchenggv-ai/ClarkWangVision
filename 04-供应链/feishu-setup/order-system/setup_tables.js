...
const TABLE_DEFS = [
  ...
  },
  {
    ...
    name: "成品库存表",
    fields: [
      { field_name: "产品型号", type: T.TEXT },  // 先用文本，后面改关联
...
const MOCK_DATA = {
  ...
  finished_inventory: [
    { "产品型号": "SKU-001", "当前库存": 85, "在产量": 40, "状态": "✅有货" },
    { "产品型号": "SKU-002", "当前库存": 60, "在产量": 30, "状态": "✅有货" },
    { "产品型号": "SKU-003", "当前库存": 45, "在产量": 20, "状态": "✅有货" },
    { "产品型号": "SKU-004", "当前库存": 12, "在产量": 0, "状态": "⚠️低库存" },
    { "产品型号": "SKU-005", "当前库存": 50, "在产量": 25, "状态": "✅有货" },
    { "产品型号": "SKU-006", "当前库存": 18, "在产量": 0, "状态": "⚠️低库存" },
    { "产品型号": "SKU-007", "当前库存": 0, "在产量": 0, "状态": "❌缺货" },
    { "产品型号": "SKU-008", "当前库存": 25, "在产量": 10, "状态": "✅有货" },
    { "产品型号": "SKU-009", "当前库存": 3, "在产量": 0, "状态": "⚠️低库存" },
    { "产品型号": "SKU-010", "当前库存": 0, "在产量": 0, "状态": "定制品" },
    { "产品型号": "SKU-011", "当前库存": 0, "在产量": 0, "状态": "定制品" },
    { "产品型号": "SKU-012", "当前库存": 0, "在产量": 0, "状态": "定制品" },
  ],
  blank_inventory: [
    { "产品型号": "SKU-001", "当前毛坯库存": 120, "在产毛坯量": 60, "可转成品数": 120 },
    { "产品型号": "SKU-002", "当前毛坯库存": 90, "在产毛坯量": 50, "可转成品数": 90 },
    { "产品型号": "SKU-003", "当前毛坯库存": 60, "在产毛坯量": 40, "可转成品数": 60 },
    { "产品型号": "SKU-004", "当前毛坯库存": 20, "在产毛坯量": 0, "可转成品数": 20 },
    { "产品型号": "SKU-005", "当前毛坯库存": 80, "在产毛坯量": 30, "可转成品数": 80 },
    { "产品型号": "SKU-006", "当前毛坯库存": 40, "在产毛坯量": 0, "可转成品数": 40 },
    { "产品型号": "SKU-007", "当前毛坯库存": 0, "在产毛坯量": 30, "可转成品数": 0 },
    { "产品型号": "SKU-008", "当前毛坯库存": 35, "在产毛坯量": 20, "可转成品数": 35 },
    { "产品型号": "SKU-009", "当前毛坯库存": 10, "在产毛坯量": 0, "可转成品数": 10 },
  ],
  mold: [
    { "模芯编号": "MC-001", "产品型号": "SKU-001", "总寿命（次）": 5000, "已使用次数": 2100, "剩余次数": 2900, "预警阈值": 500, "状态": "🟢正常" },
    { "模芯编号": "MC-002", "产品型号": "SKU-002", "总寿命（次）": 5000, "已使用次数": 3800, "剩余次数": 1200, "预警阈值": 500, "状态": "🟢正常" },
    { "模芯编号": "MC-003", "产品型号": "SKU-003", "总寿命（次）": 5000, "已使用次数": 4600, "剩余次数": 400, "预警阈值": 500, "状态": "🟡预警" },
    { "模芯编号": "MC-004", "产品型号": "SKU-004", "总寿命（次）": 4000, "已使用次数": 3950, "剩余次数": 50, "预警阈值": 500, "状态": "🔴需更换" },
    { "模芯编号": "MC-005", "产品型号": "SKU-005", "总寿命（次）": 5000, "已使用次数": 1500, "剩余次数": 3500, "预警阈值": 500, "状态": "🟢正常" },
    { "模芯编号": "MC-006", "产品型号": "SKU-006", "总寿命（次）": 5000, "已使用次数": 2800, "剩余次数": 2200, "预警阈值": 500, "状态": "🟢正常" },
    { "模芯编号": "MC-007", "产品型号": "SKU-008", "总寿命（次）": 4000, "已使用次数": 3200, "剩余次数": 800, "预警阈值": 500, "状态": "🟢正常" },
  ],
  forecast: [
    { "预测周期": "2026-W14", "产品型号": "SKU-001", "预测销量": 50, "历史参考均值": 45, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-002", "预测销量": 40, "历史参考均值": 38, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-003", "预测销量": 30, "历史参考均值": 28, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-004", "预测销量": 20, "历史参考均值": 18, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-005", "预测销量": 25, "历史参考均值": 22, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-006", "预测销量": 15, "历史参考均值": 14, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-007", "预测销量": 10, "历史参考均值": 8, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-008", "预测销量": 8, "历史参考均值": 7, "实际销量": 0, "预测准确率": "" },
    { "预测周期": "2026-W14", "产品型号": "SKU-009", "预测销量": 6, "历史参考均值": 5, "实际销量": 0, "预测准确率": "" },
  ],
  order: [
    { "订单编号": "ORD-2026-0401", "下单日期": 1743120000000, "产品型号": "SKU-001", "数量": 5, "承诺交货日": 1743379200000, "订单状态": "待处理" },
    { "订单编号": "ORD-2026-0402", "下单日期": 1743120000000, "产品型号": "SKU-007", "数量": 3, "承诺交货日": 1743552000000, "订单状态": "待处理" },
    { "订单编号": "ORD-2026-0403", "下单日期": 1743120000000, "产品型号": "SKU-004", "数量": 10, "承诺交货日": 1743379200000, "订单状态": "待处理" },
    { "订单编号": "ORD-2026-0404", "下单日期": 1743120000000, "产品型号": "SKU-009", "数量": 5, "承诺交货日": 1743552000000, "订单状态": "待处理" },
    { "订单编号": "ORD-2026-0405", "下单日期": 1743120000000, "产品型号": "SKU-010", "数量": 2, "承诺交货日": 1743552000000, "订单状态": "待处理" },
  ],
};
