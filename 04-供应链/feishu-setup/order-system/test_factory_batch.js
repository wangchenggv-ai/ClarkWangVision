...
function buildExcel(allRows, summary) {
  ...
  const summaryData = [
    ...
    [""],
    ["订单汇总"],
    ["订单号", "代理商", "顾客", "产品型号", "承诺交期", "镜片码数"],
    ...summary.orders.map(o => [o.orderNo, o.agentName, o.customerName, o.sku, o.promiseDate, o.lensCount]),
  ];

  const ws3 = XLSX.utils.aoa_to_sheet(summaryData);
  ws3["!cols"] = [{ wch: 22 }, { wch: 16 }, { wch: 12 }, { wch: 20 }, { wch: 12 }, { wch: 8 }];
