...
async function main() {
  ...
  const testOrders = [
    { "订单编号": "TEST-001", "下单日期": today, "产品型号": "SKU-001", "数量": 5 },   // 有库存→有货3天
    { "订单编号": "TEST-002", "下单日期": today, "产品型号": "SKU-007", "数量": 3 },   // 零库存→定制5天
    { "订��编号": "TEST-003", "下单日期": today, "产品型号": "SKU-009", "数量": 10 },  // 库存3<10→定制5天
  ];

  console.log("📝 新增3条测试订单（待处理）...\n");
